...
public class ALSpeechRecognitionProxy extends ALProxy
{
    ...
    /// <param name="enableWordSpotting"> If disabled, the engine expects to hear one of the specified words, nothing more, nothing less. If enabled, the specified words can be pronounced in the middle of a whole speech stream, the engine will try to spot them. </param>
    ...
    public void setVocabulary( String[] vocabulary,  Boolean enableWordSpotting)
    {

	Variant vvocabulary;
	vvocabulary = new Variant(vocabulary);
	Variant venableWordSpotting;
	venableWordSpotting = new Variant(enableWordSpotting);

	Variant result = call("setVocabulary" ,vvocabulary, venableWordSpotting);
