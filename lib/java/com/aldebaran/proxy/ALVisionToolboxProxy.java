...
public class ALVisionToolboxProxy extends ALProxy
{
    ...
    /// </summary>
    /// <returns> 0: no backlight - 1: possible backlight - 2: backlight identified </returns>
    ...
    public void logTPRInstanceInfo( int instanceNumber)
    {

	Variant vinstanceNumber;
	vinstanceNumber = new Variant(instanceNumber);

	Variant result = call("logTPRInstanceInfo" ,vinstanceNumber);
    ...
    /// <summary>
    /// Start recording a video. The .avi video is stored on the robot in the /home/nao/.local/share/naoqi/share/naoqi/vision folder. The record should be stopped by calling stopVideoRecord(). Resolution: 320*240, MJPG format, frame rate ~10-15 fps. Please note that only one record at a time can be made.
    /// </summary>
    ...
    /// <summary>
    /// Shoot 3 successives pictures and place them in the /home/nao/.local/share/naoqi/share/naoqi/vision folder. If halfPress has not been called before, it will take longer between click and shoot.
    /// </summary>
