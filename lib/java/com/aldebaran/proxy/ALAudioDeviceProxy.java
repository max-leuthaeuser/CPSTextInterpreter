...
public class ALAudioDeviceProxy extends ALProxy
{
    ...
    public void sendAudioBuffer( int arg1,  int arg2,  int arg3,  int arg4)
    {
	...
	Variant result = call("sendAudioBuffer" ,varg1, varg2, varg3, varg4);
    ...
    public void setFileAsOutput( String pFileName)
    {

	Variant vpFileName;
	vpFileName = new Variant(pFileName);

	Variant result = call("setFileAsOutput" ,vpFileName);
    ...
    /// </summary>
    /// <param name="pModule"> Smart pointer on the module </param>
    /// <param name="arg2"> arg </param>
    /// <param name="arg3"> arg </param>
    ...
    public void subscribe( String pModule,  String arg2,  String arg3)
    {
	...
	Variant result = call("subscribe" ,vpModule, varg2, varg3);
    ...
    /// </summary>
    /// <param name="pModule"> local subscriber module's name </param>
    /// <returns> True if module has subscribed successfully - False otherwise </returns>

    
    
    
    public Boolean subscribeLocalModule( String pModule)
    {

	Variant vpModule;
	vpModule = new Variant(pModule);

	Variant result = call("subscribeLocalModule" ,vpModule);
    ...
    /// </summary>
    /// <param name="pModule"> local subscriber module's name </param>
    /// <returns> True if the module has unsubscribed successfully - False otherwise </returns>

    
    
    
    public Boolean unSubscribeLocalModule( String pModule)
    {

	Variant vpModule;
	vpModule = new Variant(pModule);

	Variant result = call("unSubscribeLocalModule" ,vpModule);
