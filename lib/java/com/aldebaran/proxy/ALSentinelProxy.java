...
public class ALSentinelProxy extends ALProxy
{
    ...
    public void batteryChargeCellVoltageMinChanged( String dataName,  Variant data,  String message)
    {
	...
	Variant result = call("batteryChargeCellVoltageMinChanged" ,vdataName, vdata, vmessage);
    ...
    public void onAccX( String dataName,  Variant data,  String message)
    {
	...
	Variant result = call("onAccX" ,vdataName, vdata, vmessage);
    ...
    public void onAccY( String dataName,  Variant data,  String message)
    {
	...
	Variant result = call("onAccY" ,vdataName, vdata, vmessage);
    ...
    public void onAccZ( String dataName,  Variant data,  String message)
    {
	...
	Variant result = call("onAccZ" ,vdataName, vdata, vmessage);
    ...
    public void powerButtonOnPress( String dataName,  Variant data,  String message)
    {
	...
	Variant result = call("powerButtonOnPress" ,vdataName, vdata, vmessage);
