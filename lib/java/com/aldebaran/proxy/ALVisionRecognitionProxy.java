...
public class ALVisionRecognitionProxy extends ALProxy
{
    ...
    /// <param name="databasePath"> Absolute path of the database on the robot. </param>
    /// <returns>  </returns>
    ...
    public int changeDatabase( String databaseName,  String databasePath)
    {
	...
	Variant result = call("changeDatabase" ,vdatabaseName, vdatabasePath);
